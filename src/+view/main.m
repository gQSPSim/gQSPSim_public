...
% %             delete(app.UIFigure)
    ...
    methods(Static)
        ...
        function paneClass = getPaneClassFcnFromPaneType(paneType)
            arguments
                paneType (1,1) string
            end
            
            prefix = "QSPViewerNew.Application.";
            switch paneType
                case 'Task'
                    paneClass = "TaskPane";
                case 'Parameters'
                    paneClass = "ParametersPane";
                case 'Simulation'
                    paneClass = "SimulationPane";
                case 'Optimization'
                    paneClass = "OptimizationPane";
                otherwise
                    paneClass = "SessionPane";            
            end
            paneClass = eval("@" + prefix + paneClass);
        end
