function Main
    version = '1.1';
    logo_gQSPSim(version)
end

function logo_gQSPSim(version)
    figure
    load QSP_Sim.mat
    ...
    text(9.9, 9000, version, 'FontSize', 250, 'FontWeight', 'bold', 'color', 'k');
    ...
    % get the image data.
    I = getframe(gcf);
    I16 = imresize(I.cdata, [16 16]);
    I24 = imresize(I.cdata, [24 24]);
    I48 = imresize(I.cdata, [48 48]);
    
    imwrite(I16, '../gQSPSim_resources/icon_16.png', 'png');
    imwrite(I24, '../gQSPSim_resources/icon_24.png', 'png');
    imwrite(I48, '../gQSPSim_resources/icon_48.png', 'png');
