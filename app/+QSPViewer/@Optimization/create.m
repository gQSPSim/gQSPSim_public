...
vObj.h.PlotHistoryCheckbox = matlab.ui.control.UIControl( ...
    'Parent',vObj.h.ParametersLayout,...
    'Style', 'checkbox', ...
    'FontSize',10,...
    'Enable','off',...
    'String','Keep History',...
    'Callback',@(h,e)onKeepHistoryPlotCheckbox(vObj,h,e) );
...
% Source
vObj.h.PlotParametersSourcePopup = ...
    uix.widget.PopupFieldWithLabel(...
    'Parent',vObj.h.ParametersLayout,...
    'String',{'-'},...
    'LabelString','Source',...
    'LabelFontSize',10,...
    'LabelFontWeight','bold',...
    'Callback',@(h,e)onPlotParametersSourcePopup(vObj,h,e));
...
vObj.h.ParametersLayout.Heights = [WidgetHeight -1 WidgetHeight -1 WidgetHeight];
