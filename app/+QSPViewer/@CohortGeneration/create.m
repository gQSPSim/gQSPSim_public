...
vObj.h.SaveInvalidPopup = ...
    uix.widget.PopupFieldWithLabel(...
    'Parent',GridLayout,...
    'String',{'all','valid'},... % {'Save all virtual subjects', 'Save valid virtual subjects'},...
...
vObj.h.MaxTracesEdit = uix.widget.EditFieldWithLabel(...
    'Parent',VisualizationLayout,...
    'Value', 200,...
    'LabelString','Max traces to display',...
    'LabelFontSize',10,...
    'LabelFontWeight','bold',...
    'LabelLocation','left',...
    'LabelWidth',LabelWidth+2,...
    'LabelTooltip','Maximum number of traces to display',...
    'Tag','MaxTraceEdit',...
    'Callback',@(h,e)onMaxTracesEdit(vObj,h,e));
...
% Sizes
VisualizationLayout.Heights = [35 70 40 -1 30 -1];
