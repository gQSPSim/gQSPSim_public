    ...
    switch Type
        ...
        case 'QSP.Session'
            ...
            hVPops = i_addNode(hSettings, Data.Settings, ...
                'Virtual Patients', 'stickman3.png',...
            ...
            hCohortGen = i_addNode(hSession, Data, ...
                'Virtual Cohort Generation', 'stickman.png',...
            ...
            hVPopGens = i_addNode(hSession, Data, ...
                'Virtual Population Generation', 'stickman2.png',...
        ...
        case 'QSP.Task'
            ...
            hNode = i_addNode(Parent, Data, Data.Name, 'flask.png',...
        ...
        case 'QSP.CohortGeneration'
            ...
            hNode = i_addNode(Parent, Data, Data.Name, 'stickman.png',...
                obj.h.TreeMenu.Leaf.CohortGeneration, [], '');
            Data.TreeNode = hNode; %Store node in the object for cross-ref            
            
        case 'QSP.VirtualPopulationGeneration'
            
            hNode = i_addNode(Parent, Data, Data.Name, 'stickman2.png',...
