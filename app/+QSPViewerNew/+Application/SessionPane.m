classdef SessionPane < QSPViewerNew.Application.ViewPane 
    ...
    methods (Access = private)
        ...
        function create(obj)
            ...
            obj.LoggerSeverityDialogDropDown.Items = {'ERROR: Only error level messages are logged', ...
            ...
            obj.LoggerSeverityDialogDropDown.ItemsData = {mlog.Level.ERROR, ...
                mlog.Level.WARNING, ...
                mlog.Level.INFO, ...
                mlog.Level.MESSAGE, ...
                mlog.Level.DEBUG};
            ...
            obj.LoggerSeverityFileDropDown.Items = {'ERROR: Only error level messages are logged', ...
                'WARNING: Only warning or error level messages are logged', ...
                'INFO: Informational messages are logged, plus all the above', ...
                'MESSAGE: Messages to the user are logged, plus all of the above', ...
                'DEBUG_INFO: Additional debugging info messages are logged, plus all of the above'};
            obj.LoggerSeverityFileDropDown.ItemsData = {mlog.Level.ERROR, ...
                mlog.Level.WARNING, ...
                mlog.Level.INFO, ...
                mlog.Level.MESSAGE, ...
                mlog.Level.DEBUG};
